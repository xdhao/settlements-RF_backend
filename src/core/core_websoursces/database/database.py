...
if DB_HOST and DB_PASSWORD and DB_PORT:
    SQLALCHEMY_DATABASE_URL_ASYNC = f"postgresql+asyncpg://postgres:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/settlements_db"
else:
    SQLALCHEMY_DATABASE_URL_ASYNC = "postgresql+asyncpg://postgres:1234@127.0.0.1:5432/settlements_db"

SQLALCHEMY_DATABASE_URL_SYNC = "postgresql://postgres:1234@127.0.0.1:5432/settlements_db"
